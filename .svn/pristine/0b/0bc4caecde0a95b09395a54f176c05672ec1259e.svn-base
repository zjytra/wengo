...
func (qb *MySQLQueryBuilder) InsertInto(table string, fields ...string) *MySQLQueryBuilder {
...
func (qb *MySQLQueryBuilder) Values(vals ...string) *MySQLQueryBuilder {
...
func NewQueryBuilder() *MySQLQueryBuilder{
